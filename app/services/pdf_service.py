...
class PDFService:
    ...
    def encode_pixmap_for_ocr(self, pix) -> Tuple[str, Tuple[int, int]]:
        ...
        and explicit try...finally lifecycle management. Returns (image_b64, page_size).
    ...
    def render_page_preview_webp(self, pdf_path: str, pageno_idx: int) -> bytes:
        """Render page to WEBP format for quick UI preview with direct matrix downscaling and guaranteed lifecycle cleanup."""

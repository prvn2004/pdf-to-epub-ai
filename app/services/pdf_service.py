...
class PDFService:
    ...
    def encode_pixmap_for_ocr(self, pix) -> Tuple[str, Tuple[int, int], float]:
        """Convert PyMuPDF pixmap to JPEG base64 string capped by MAX_IMAGE_SIDE. Returns (image_b64, page_size, scale)."""
        ...
        return img_b64, (pix.height, pix.width), scale
    ...
    def render_page_for_ocr(self, pdf_path: str, pageno_idx: int) -> Tuple[str, Tuple[int, int], float, Any]:
        ...
        img_b64, page_size, scale = self.encode_pixmap_for_ocr(pix)
